<template>
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-8">
                <router-link to="/" class="btn btn-primary btn-sm rounded shadow mb-3">Back</router-link>
                    ...
                    <div class="card-body">
                        <form @submit.prevent="update()">
                            ...
                            <div class="mb-3">
                                ...
                                />
                                <div
                                    v-if="validation.time"
                                    class="text-danger"
                                >{{ validation.time[0] }}</div>
                            </div>
                            <div class="mb-3">
...
export default {
    setup() {
        ...
        onMounted(() => {
            ...
            axios.get(`http://course-laravel-akuntapi.test/api/transaction/${route.params.id}`)
                .then((result) => {
        ...
        function update() {
            axios
                .put(`http://course-laravel-akuntapi.test/api/transaction/${route.params.id}`, transaction)
                .then(() => {
                    router.push({
